---
name: developer
description: Implements tktk beads issues against the Hono/Cloudflare Workers/D1/Drizzle/htmx stack. Use to pick up a ready bd issue and turn it into working, thin route handlers with logic in src/lib/.
...
- Write/extend the Drizzle schema Postgres-compatible (see `CLAUDE.md` rule 2) even for D1-only features.
