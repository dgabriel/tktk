...
// self-serve — this app has no student view yet to book your own slot
// from, so this is the honest stand-in until that exists.
  ...
  return (
    <details className="lesson-import office-hours-section">
      ...
      <p className="lesson-import-hint">
        Self-serve booking isn&rsquo;t available yet (no student view in this prototype) — this lets you
        add slots and record who&rsquo;s booked each one.
      </p>
